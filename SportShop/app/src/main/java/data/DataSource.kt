...
object DataSource {
    ...
    val products_hats = listOf(Product("Кепка зеленая",description,R.drawable.ic_hat3,"Кепки",2000,manufacturer2),
        ...
        Product("Кепка зеленая",description,R.drawable.ic_hat3,"Кепки",2000,manufacturer2),
        Product("Кепка белая",description, R.drawable.ic_hat1,"Кепки",2000,manufacturer2),
        Product("Кепка черная",description,R.drawable.ic_hat2,"Кепки",2000,manufacturer1)
    )

    val products_sweatshirts = listOf(
